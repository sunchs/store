package com.sunchs.store.shop.gateway.filter;

import com.netflix.zuul.ZuulFilter;
import com.netflix.zuul.context.RequestContext;
import com.sunchs.store.shop.framework.bean.RequestData;
import com.sunchs.store.shop.framework.bean.ResultData;
import com.sunchs.store.shop.framework.constants.CacheKeys;
import com.sunchs.store.shop.framework.util.JsonUtil;
import com.sunchs.store.shop.framework.util.RedisUtil;
import com.sunchs.store.shop.framework.util.StreamUtil;
import com.sunchs.store.shop.framework.util.StringUtil;
